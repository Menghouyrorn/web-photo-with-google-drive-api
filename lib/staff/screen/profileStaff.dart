...
import 'package:theringphoto/screens/customer.dart';
...
class _ProfileStaffState extends State<ProfileStaff> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              const Text('Your session has timed out. Please log in again.'),
          actions: [
            TextButton(
              child: const Text('Ok'),
              onPressed: () {
  ...
  void startSessionTimeoutTimer(BuildContext context, int timeoutInSeconds) {
    Timer(Duration(seconds: timeoutInSeconds), () {
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        ...
                        // startSessionTimeoutTimer(context, 1);
                      },
                      child: const Text(
                        "Edit",
