// ignore_for_file: deprecated_member_use, unused_local_variable, duplicate_ignore
...
class ListAlbumsAdmin extends StatefulWidget {
  const ListAlbumsAdmin({super.key});

  @override
  State<ListAlbumsAdmin> createState() => _ListAlbumsAdminState();
}

class _ListAlbumsAdminState extends State<ListAlbumsAdmin> {
        ...
        for (final file in createdFile.files!) {
          if (file.id == idFolder) {
            ...
            if (body['message'] == 'success') {
              linkalbums.text = "";
              getDataFromApi();
              MessageDialog.showMessageDialog('Folder Add success');
            } else {
  ...
  Future<void> _updateFolderName(
    ...
    try {
      ...
      if (titlealbum.text.isNotEmpty) {
        ...
        MessageDialog.showMessageDialog('Folder update success');
        titlealbum.text = "";
        getDataFromApi();
  ...
  Widget build(BuildContext context) {
    if (currentUser.isNotEmpty) {
      if (storeCurrentData.getItem(currentUser['id'].toString()) == null) {
        ...
        print(storeCurrentData.getItem(currentUser['id'].toString()));
